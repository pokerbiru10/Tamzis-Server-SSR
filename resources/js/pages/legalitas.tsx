...
// Ikon kartu keunggulan mengikuti urutan item (konten teks dikelola dashboard).
...
export default function Legalitas() {
    ...
    const { t } = useProfilePageContent('legalitas', legalitasDefaults, locale);
        ...
        <>
            ...
            <div className="min-h-screen bg-[#f8f9fa] font-sans text-emerald-950">
                ...
                <div className="mx-auto max-w-7xl px-6 py-12 sm:py-16">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2">
                        {t.details.map((item, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className="group rounded-2xl border border-emerald-900/5 bg-white p-8 shadow-sm transition-colors hover:border-emerald-500"
                                >
                                    <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-emerald-700 transition-all group-hover:bg-emerald-700 group-hover:text-white">
                                        <Icon className="h-6 w-6" />
                                    </div>
                                    <h3 className="mb-3 text-base font-bold text-emerald-950">
                                        {item.title}
                                    </h3>
                    ...
                    {/* Legalitas Tamzis Section */}
                    <div className="mt-16">
                        <div className="mb-8 text-center">
                            <span className="mb-4 inline-block rounded-full bg-emerald-100 px-4 py-1.5 text-[10px] font-bold tracking-widest text-emerald-700 uppercase">
                                {t.legalTamzis.badge}
                            </span>
                        ...
                        <div className="mx-auto max-w-3xl overflow-hidden rounded-2xl border border-emerald-900/5 bg-white shadow-sm">
                            {t.legalTamzis.items.map((item, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center gap-4 px-8 py-5 ${
                                        index !== t.legalTamzis.items.length - 1
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="text-[10px] font-bold tracking-widest text-emerald-950/50 uppercase">
                                            {item.label}
                                        </div>
                                        <div className="text-sm font-bold text-emerald-950 sm:text-base">
                                            {item.value}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="mt-16">
                        ...
                        <div className="mx-auto max-w-3xl overflow-hidden rounded-2xl border border-emerald-900/5 bg-white shadow-sm">
                            {t.baitulMaal.items.map((item, index) => (
                                <div
                                    key={index}
                                    className={`flex items-center gap-4 px-8 py-5 ${
                                        index !== t.baitulMaal.items.length - 1
                                            ? 'border-b border-emerald-900/5'
                                            : ''
                                    }`}
                                >
                    ...
                    <div className="relative mt-20 overflow-hidden rounded-2xl bg-emerald-950 p-8 text-white shadow-2xl sm:p-12">
                        <div className="relative z-10 grid items-center gap-10 text-center md:grid-cols-3 md:text-left">
                            <div className="md:col-span-2">
                                <h3 className="mb-3 text-xl font-bold">
                                    {t.official.title}
                                </h3>
                                <p className="text-lg font-bold tracking-tight text-emerald-400 uppercase sm:text-2xl">
                                    {t.official.value}
                                </p>
                            </div>
                            <div className="flex justify-center md:justify-end">
                                <div className="flex h-24 w-24 items-center justify-center rounded-full border-2 border-emerald-800 bg-white/5">
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="rounded-2xl border border-emerald-900/10 bg-white p-8 text-center shadow-sm">
                                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-xl bg-emerald-50 text-emerald-700">
