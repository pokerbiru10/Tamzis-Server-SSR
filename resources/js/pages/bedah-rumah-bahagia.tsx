...
export default function BedahRumahBahagia() {
    const { props } = usePage();
    ...
    const translations = {
        id: {
            title: 'Bedah Rumah Bahagia - TAMZIS Bina Utama',
            heading: 'Bedah Rumah Bahagia',
            breadcrumb: {
                home: 'Beranda',
                baitulMaal: 'Baitul Maal',
                current: 'Bedah Rumah Bahagia',
            },
            hero: {
                badge: 'Program Baitul Maal',
                title: 'Bedah Rumah Bahagia',
                hadits: '"Program renovasi rumah tidak layak huni untuk menciptakan lingkungan tempat tinggal yang sehat, nyaman, dan meningkatkan kualitas hidup mustahik."',
                haditsSource: '',
                content: `LATAR BELAKANG
Rumah adalah kebutuhan dasar setiap manusia untuk hidup dengan aman, nyaman, dan bermartabat. Namun kenyataannya, masih banyak keluarga dhuafa yang hidup di rumah tidak layak huni — berdinding anyaman bambu rapuh, berlantaikan tanah, beratap bocor, dan tanpa sanitasi memadai. Kondisi ini tidak hanya mengganggu kenyamanan, tetapi juga mengancam kesehatan dan keselamatan mereka, terutama anak-anak, lansia, dan penyandang disabilitas.

Keterbatasan ekonomi membuat mereka tidak mampu memperbaiki atau membangun rumah yang layak. Sementara itu, bantuan dari pemerintah terbatas dan belum menjangkau seluruh masyarakat miskin. Situasi ini membutuhkan kepedulian dan peran aktif dari masyarakat luas, lembaga sosial, dan para dermawan.

Menjawab kebutuhan tersebut, lahirlah Program "Bedah Rumah Bahagia untuk Dhuafa" sebagai bentuk aksi nyata untuk menghadirkan tempat tinggal yang layak bagi keluarga dhuafa. Program ini tidak hanya memperbaiki fisik bangunan, tetapi juga menumbuhkan harapan, semangat hidup, dan keberdayaan sosial bagi penerima manfaat.

Melalui pendekatan kolaboratif antara lembaga sosial, donatur, relawan, dan masyarakat sekitar, program ini diharapkan menjadi gerakan bersama untuk menciptakan lingkungan yang lebih manusiawi, berdaya, dan penuh kebahagiaan.

TUJUAN
• Meningkatkan kualitas hidup kaum dhuafa melalui penyediaan rumah layak huni.
• Mengurangi risiko kesehatan dan keselamatan akibat kondisi rumah yang tidak memadai.
• Menumbuhkan semangat gotong royong masyarakat.

SASARAN
Keluarga yang berada dalam kondisi ekonomi lemah dan tinggal di rumah tidak layak huni, khususnya yang memenuhi kriteria sebagai mustahik (fakir/miskin).`,
            },
            sidebar: {
        ...
        en: {
            title: 'Happy Home Renovation - TAMZIS Bina Utama',
            heading: 'Happy Home Renovation',
            breadcrumb: {
                home: 'Home',
                baitulMaal: 'Baitul Maal',
                current: 'Happy Home Renovation',
            },
            hero: {
                badge: 'Baitul Maal Program',
                title: 'Happy Home Renovation',
                hadits: '"A program to renovate uninhabitable houses to create a healthy and comfortable living environment and improve the quality of life for mustahik."',
                haditsSource: '',
                content: `BACKGROUND
A house is a basic need for every human being to live safely, comfortably, and with dignity. However, the reality is that many dhuafa families still live in uninhabitable houses — with fragile bamboo walls, dirt floors, leaky roofs, and inadequate sanitation. This condition not only affects comfort but also threatens their health and safety, especially for children, the elderly, and persons with disabilities.

Economic limitations prevent them from repairing or building decent homes. Meanwhile, government assistance is limited and has not reached all impoverished communities. This situation requires care and active involvement from the broader community, social institutions, and philanthropists.

Addressing these needs, the "Happy House Renovation for Dhuafa" Program was born as a concrete action to provide decent housing for dhuafa families. This program not only improves the physical structure of buildings but also fosters hope, life spirit, and social empowerment for beneficiaries.

Through a collaborative approach between social institutions, donors, volunteers, and surrounding communities, this program is expected to become a collective movement to create a more humane, empowered, and joyful environment.

OBJECTIVES
• Improve the quality of life for dhuafa through the provision of habitable homes.
• Reduce health and safety risks caused by inadequate housing conditions.
• Foster community spirit of mutual cooperation.

TARGETS
Families in weak economic conditions living in uninhabitable houses, particularly those who meet the criteria as mustahik (poor/needy).`,
            },
            sidebar: {
                    ...
                    <div className="grid items-start gap-12 lg:grid-cols-3">
                        <div className="space-y-10 lg:col-span-2">
                            <div className="rounded-2xl border-l-[8px] border-emerald-500 bg-emerald-800 p-8 text-white shadow-xl sm:p-12">
                                ...
                                <picture>
                                    <source type="image/webp" srcSet="/assets/img/menu/bedah-rumah.webp" />
                                    <ImageWithFallback src="/assets/img/menu/bedah-rumah.png" alt={t.hero.title} aspectRatio="video" />
                                </picture>
                                </div>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="rounded-2xl border border-emerald-900/10 bg-white p-8 text-center shadow-sm">
                                ...
                                <a href="https://wa.me/6281236290808?text=Halo%20TAMZIS%2C%20saya%20ingin%20bertanya%20tentang%20Bedah%20Rumah%20Bahagia" target="_blank" rel="noreferrer" className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#25D366] py-4 text-sm font-bold text-white shadow-lg shadow-green-500/20 transition-all hover:bg-[#128C7E] active:scale-95">{t.sidebar.contact.btn}</a>
                            </div>
                        </div>
                    </div>
                </div>
