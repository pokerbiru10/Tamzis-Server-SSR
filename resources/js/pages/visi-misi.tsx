...
import { ChevronRight, Phone, Compass, CheckCircle2 } from 'lucide-react';
                    ...
                    <div className="grid items-start gap-12 lg:grid-cols-3">
                        ...
                        <div className="space-y-10 lg:col-span-2">
                            ...
                            <div className="rounded-2xl border-l-[8px] border-emerald-500 bg-emerald-800 p-8 text-white shadow-xl sm:p-12">
                                ...
                                {/* Image Section - Forced 16:9 Landscape */}
                                ...
                                <div className="space-y-4 text-sm leading-relaxed font-medium text-white/90 sm:text-lg">
                                    <p>{t.intro.content1}</p>
                                </div>
                            </div>

                            {/* Visi Card */}
                            <div className="relative overflow-hidden rounded-3xl border border-emerald-900/5 bg-white p-8 shadow-sm sm:p-10">
                                {/* Decorative abstract background element */}
                                <div className="absolute -top-10 -right-10 text-emerald-50 opacity-50">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-4 text-base leading-relaxed font-semibold text-emerald-900 sm:text-lg">
                                        <p>{t.visi.content}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Misi Card */}
                            <div className="rounded-3xl border border-emerald-900/5 bg-white p-8 shadow-sm sm:p-10">
                                ...
                                <ul className="space-y-4">
                                    {t.misi.items.map((misi, idx) => (
                                        <li
                                            key={idx}
                                            className="flex items-start gap-4"
                                        >
                                            <div className="mt-0.5 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-50 text-xs font-bold text-emerald-600">
                                                {idx + 1}
                                            </div>
                                            <p className="text-base leading-relaxed font-medium text-emerald-950/80">
                                                {misi}
                                            </p>
                                        </li>
                                    ))}
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="rounded-2xl border border-emerald-900/10 bg-white p-8 text-center shadow-sm">
                                ...
                                <a
                                    href="https://wa.me/628112613134?text=Halo%20TAMZIS%2C%20saya%20ingin%20bertanya%20tentang%20Visi%20dan%20Misi"
                                    target="_blank"
                                    rel="noreferrer"
