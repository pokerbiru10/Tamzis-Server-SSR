...
export default function Bahagia1000YatimDanDhuafa() {
    const { props } = usePage();
    ...
    const translations = {
        id: {
            title: 'Bahagia 1000 Yatim dan Dhuafa - TAMZIS Bina Utama',
            heading: 'Bahagia 1000 Yatim dan Dhuafa',
            breadcrumb: {
                home: 'Beranda',
                baitulMaal: 'Baitul Maal',
                current: 'Bahagia 1000 Yatim dan Dhuafa',
            },
            hero: {
                badge: 'Program Baitul Maal',
                title: 'Bahagia 1000 Yatim dan Dhuafa',
                hadits: '"Program berbagi kebahagiaan dan santunan kepada anak yatim dan dhuafa selama bulan Ramadhan."',
                haditsSource: '',
                content:
                    'Program berbagi kebahagiaan dan santunan kepada anak yatim dan dhuafa selama bulan Ramadhan.',
            },
            sidebar: {
        ...
        en: {
            title: 'Happy 1000 Orphans and Dhuafa - TAMZIS Bina Utama',
            heading: 'Happy 1000 Orphans and Dhuafa',
            breadcrumb: {
                home: 'Home',
                baitulMaal: 'Baitul Maal',
                current: 'Happy 1000 Orphans and Dhuafa',
            },
            hero: {
                badge: 'Baitul Maal Program',
                title: 'Happy 1000 Orphans and Dhuafa',
                hadits: '"A program of sharing happiness and providing assistance to orphans and dhuafa during the month of Ramadhan."',
                haditsSource: '',
                content:
                    'A program of sharing happiness and providing assistance to orphans and dhuafa during the month of Ramadhan.',
            },
            sidebar: {
                    ...
                    <div className="grid items-start gap-12 lg:grid-cols-3">
                        ...
                        <div className="space-y-10 lg:col-span-2">
                            ...
                            <div className="rounded-2xl border-l-[8px] border-emerald-500 bg-emerald-800 p-8 text-white shadow-xl sm:p-12">
                                ...
                                <picture>
                                    <source type="image/webp" srcSet="/assets/img/menu/bahagia.webp" />
                                    <ImageWithFallback
                                        src="/assets/img/menu/bahagia.png"
                                        alt={t.hero.title}
                                        aspectRatio="video"
                                    />
                                </picture>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <SidebarMenuNav
                                group="baitul-maal"
                                locale={locale}
                                activeUrl="/bahagia-1000-yatim-dan-dhuafa"
