...
import { ChevronRight, History, Phone } from 'lucide-react';
                    ...
                    <div className="grid items-start gap-12 lg:grid-cols-3">
                        ...
                        <div className="space-y-10 lg:col-span-2">
                            ...
                            <div className="rounded-2xl border-l-[8px] border-emerald-500 bg-emerald-800 p-8 text-white shadow-xl sm:p-12">
                                ...
                                <div className="space-y-5 text-sm leading-relaxed font-medium text-white/90 sm:text-lg">
                            ...
                            <div className="rounded-3xl border border-emerald-900/5 bg-white p-8 shadow-sm sm:p-10">
                                ...
                                <div className="space-y-4 text-sm leading-relaxed font-medium text-emerald-950/80">
                                    <p>{t.journey.content1}</p>
                                    <p>{t.journey.content2}</p>
                                    <p>{t.journey.content3}</p>
                                </div>
                            </div>
